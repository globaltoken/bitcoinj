 ...
 *
 * <ul>
 * <li>{@code globaltoken:<address>}</li>
 * <li>{@code globaltoken:<address>?<name1>=<value1>&<name2>=<value2>} with multiple
...
public class BitcoinURI {
     ...
     */
    @Deprecated
    public static final String BITCOIN_SCHEME = "globaltoken";
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        // URI is formed as  globaltoken:<address>?<query parameters>
        // blockchain.info generates URIs of non-BIP compliant form globaltoken://address?....
        ...
        // For instance with : globaltoken:129mVqKUmJ9uwPxKJBnNdABbuaaNfho4Ha?amount=0.06&label=Tom%20%26%20Jerry
        ...
        if (addressSplitTokens.length == 0)
            throw new BitcoinURIParseException("No data found after the globaltoken: prefix");
