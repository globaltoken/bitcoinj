...
public class BuildCheckpoints {
    ...
    private static void sanityCheck(File file, int expectedSize) throws IOException {
        ...
        if (params.getId().equals(NetworkParameters.ID_MAINNET)) {
            StoredBlock test = manager.getCheckpointBefore(1502699458); // Thu Jan 23 19:00:00 CET 2014
            checkState(test.getHeight() == 222158);
            checkState(test.getHeader().getHashAsString()
                    .equals("000000000000036b0385aea5c398010f73a609ec9920673bcd4c765151a0e060"));
        } else if (params.getId().equals(NetworkParameters.ID_TESTNET)) {
            StoredBlock test = manager.getCheckpointBefore(1483418896);
            checkState(test.getHeight() == 1);
            checkState(test.getHeader().getHashAsString()
                    .equals("0000000097fcef2abcd5b827feffb2625fa50ef1794d8efc75ddbfaa3daeb499"));
        }
    }
